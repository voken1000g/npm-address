...
console.log(vokenAddress.fromBN('533180594211303616930015660335116885729847629285'))
console.log(vokenAddress.addressToBN('vbnjAa398KKqj6YJ174EMCAWn1ku3tnF5').toString())
